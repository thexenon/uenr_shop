...
import 'package:uenr_shop/models/AppReview.dart';
import 'package:uenr_shop/services/authentification/authentification_service.dart';
import 'package:uenr_shop/services/database/app_review_database_helper.dart';
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                ...
                InkWell(
                  onTap: () async {
                    const String linkedInUrl = "https://wa.me/+233505389520";
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        const String githubUrl = "https://github.com/thexenon";
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        const String linkedInUrl =
                            "https://www.linkedin.com/in/derek-donkor-32047720a";
                        await launchUrl(linkedInUrl);
                      },
                    ),
                    IconButton(
                      ...
                      onPressed: () async {
                        const String instaUrl =
                            "https://www.instagram.com/donkorderek";
                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      padding: EdgeInsets.all(16),
                      onPressed: () async {
                        const String telegramUrl = "https://t.me/the_xenon";
