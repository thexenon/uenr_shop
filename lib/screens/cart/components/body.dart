...
import 'package:uenr_shop/components/product_short_detail_card.dart';
import 'package:uenr_shop/constants.dart';
import 'package:uenr_shop/models/CartItem.dart';
import 'package:uenr_shop/models/OrderedProduct.dart';
import 'package:uenr_shop/models/Product.dart';
import 'package:uenr_shop/screens/cart/components/checkout_card.dart';
import 'package:uenr_shop/screens/product_details/product_details_screen.dart';
import 'package:uenr_shop/services/data_streams/cart_items_stream.dart';
...
class _BodyState extends State<Body> {
  ...
  Future<void> checkoutButtonCallback() async {
    ...
    orderFuture.then((orderedProductsMap) async {
      if (orderedProductsMap != null) {
        final dateTime = DateTime.now();
        final formatedDateTime =
            "${dateTime.day}-${dateTime.month}-${dateTime.year}";

        List<OrderedProduct> orderedProducts = orderedProductsMap
            .map(
              (e) => OrderedProduct(
                null,
                productUid: e['id'],
