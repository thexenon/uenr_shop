...
import 'package:uenr_shop/exceptions/local_files_handling/image_picking_exceptions.dart';
import 'package:uenr_shop/exceptions/local_files_handling/local_file_handling_exception.dart';
import 'package:uenr_shop/models/Product.dart';
import 'package:uenr_shop/screens/edit_product/provider_models/ProductDetails.dart';
import 'package:uenr_shop/services/database/product_database_helper.dart';
import 'package:uenr_shop/services/firestore_files_access/firestore_files_access_service.dart';
import 'package:uenr_shop/services/local_files_access/local_files_access_service.dart';
...
class _EditProductFormState extends State<EditProductForm> {
  ...
  Widget buildOriginalPriceField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: "e.g., 5999.0",
        labelText: "Original Price (in GHs)",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (_) {
  ...
  Widget buildDiscountPriceField() {
    return TextFormField(
      ...
      decoration: InputDecoration(
        hintText: "e.g., 2499.0",
        labelText: "Current Price (in GHs)",
        floatingLabelBehavior: FloatingLabelBehavior.always,
      ),
      validator: (_) {
